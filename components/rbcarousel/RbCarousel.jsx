...
import { DomHandler, IconUtils, ObjectUtils, UniqueComponentId, classNames, mergeProps } from 'primereact/utils';
...
export const RbCarousel = React.memo(
...
RbCarousel.displayName = 'RbCarousel';
